...
// *.ino files and so needs to be passed into the cpp file as a function
// pointer.
void checkJoystickInput(Direction *input, bool *input_registered,
...
// *.ino files and so needs to be passed into the cpp file as a function
// pointer.
void checkButtonsInput(Direction *input, bool *input_registered,
