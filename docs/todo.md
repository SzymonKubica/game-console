...
- [ ] add pong with proper 'physics' (i.e. rotation and friction)
  ...
  - [ ] add fancy physics
  - [ ] make paddle accelerate with its own velocity
  - [ ] add pong thumbnail
...
# Done
- [x] bar graph: if temperatures are above & below 0 draw a line that shows the 0
...
- [x] add logo rendering and only render it once (this should be done inside of `collect_configuration_single_option_with_thumbnails`)
